...
<form method="POST" action="./edit.php?id=<?php echo $id; ?>" class="mx-auto max-w-md">
    <div class="mb-3">
        ...
        <input name="fname" type="text" value="<?php echo $employee['fname'] ?>"
    ...
    <div class="mb-3">
        ...
        <input name="lname" type="text" value="<?php echo $employee['lname'] ?>"
            class="form-input rounded-md shadow-sm w-full py-2 px-3 text-gray-700 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
    ...
    <div class="mb-3">
        ...
        <input name="address" type="text" value="<?php echo $employee['address'] ?>"
            class="form-input rounded-md shadow-sm w-full py-2 px-3 text-gray-700 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
    ...
    <div class="mb-3">
        ...
        <input name="tel" type="text" value="<?php echo $employee['tel'] ?>"
            class="form-input rounded-md shadow-sm w-full py-2 px-3 text-gray-700 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
    ...
    <div class="mb-3">
        ...
        <input name="username" type="text" value="<?php echo $employee['username'] ?>"
            class="form-input rounded-md shadow-sm w-full py-2 px-3 text-gray-700 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
